...
class signup extends CI_Controller
{
  ...
  function index()
  {
    ...
    else
    {
      ...
      {
        $this->session->set_flashdata('msg2','<div class="alert alert-success text-center">You are Successfully Registered! Please login to access your Profile!</div>');
        redirect('index.php/signup');
      }
      else
      {
        // error
        $this->session->set_flashdata('msg2','<div class="alert alert-danger text-center">Oops! Error.  Please try again later!!!</div>');
        redirect('index.php/signup');
      }
    }
  }
