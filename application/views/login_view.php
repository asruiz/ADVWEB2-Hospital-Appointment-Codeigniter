...
<div class="container" style="margin: auto; margin-top: 100px;">
	<div class="row">
		...
		<?php $attributes = array("name" => "loginform");
			...
			<legend>Login for Patients</legend>
	...
	<div class="row">
		...
		<b>New User? </b> <a href="<?php echo base_url(); ?>index.php/signup"><b>Sign Up Here</b></a><br/>
		<b>Are you a doctor? </b><a href="<?php echo base_url(); ?>index.php/login_doc"><b>Log in Here</b></a>
		</div>
	</div>
</div>
