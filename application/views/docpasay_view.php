<body style="background-image: url('../assets/portfolio/images/background.jpg');  background-color: turquoise;
background-size: 100% 100%; background-attachment: fixed; background-repeat: no-repeat;" onload="makeTableScroll();">
<!-- Page Content -->
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
